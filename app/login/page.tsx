          ...
          <div>
            ...
            <div className="relative group">
              ...
              <button
                ...
                className="absolute inset-y-0 right-0 pr-3 sm:pr-4 flex items-center justify-center text-gray-500 hover:text-blue-600 active:text-blue-700 transition-colors"
