            ...
            <div className="relative group">
              ...
              >
                {showPassword ? (
                  ...
                  <svg className="h-6 w-6 sm:h-7 sm:w-7" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M12 7c2.76 0 5 2.24 5 5 0 .65-.13 1.26-.36 1.83l2.92 2.92c1.51-1.26 2.7-2.89 3.43-4.75-1.73-4.39-6-7.5-11-7.5-1.4 0-2.74.25-3.98.7l2.16 2.16C10.74 7.13 11.35 7 12 7zM2 4.27l2.28 2.28.46.46A11.804 11.804 0 001 12c1.73 4.39 6 7.5 11 7.5 1.55 0 3.03-.3 4.38-.84l.42.42L19.73 22 21 20.73 3.27 3 2 4.27zM7.53 9.8l1.55 1.55c-.05.21-.08.43-.08.65 0 1.66 1.34 3 3 3 .22 0 .44-.03.65-.08l1.55 1.55c-.67.33-1.41.53-2.2.53-2.76 0-5-2.24-5-5 0-.79.2-1.53.53-2.2zm7.98-6.29C6.25 1.75 2.09 3.56.95 7.78c2.73 7.51 8.6 11.71 16.02 11.71 1.91 0 3.81-.22 5.64-.69l-2.46-2.46c-.67.25-1.41.4-2.18.4-3.53 0-6.43-2.85-6.43-6.43-.05-.78.15-1.52.4-2.18l-2.54-2.54z" />
                  </svg>
                )}
              </button>
            </div>
