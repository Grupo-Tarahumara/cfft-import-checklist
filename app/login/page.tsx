          ...
          <div>
            ...
            <div className="relative group">
              ...
              <button
                ...
                className="absolute inset-y-0 right-0 pr-3 sm:pr-4 flex items-center justify-center text-gray-400 hover:text-blue-500 active:text-blue-600 transition-colors group-focus-within:text-blue-500 rounded-r-xl"
